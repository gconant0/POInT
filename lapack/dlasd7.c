/* dlasd7.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd7_(icompq, nl, nr, sqre, k, d__, z__, zw, vf, vfw, 
	vl, vlw, alpha, beta, dsigma, idx, idxp, idxq, perm, givptr, givcol, 
	ldgcol, givnum, ldgnum, c__, s, info)
integer *icompq, *nl, *nr, *sqre, *k;
doublereal *d__, *z__, *zw, *vf, *vfw, *vl, *vlw, *alpha, *beta, *dsigma;
integer *idx, *idxp, *idxq, *perm, *givptr, *givcol, *ldgcol;
doublereal *givnum;
integer *ldgnum;
doublereal *c__, *s;
integer *info;
{
    ...
    static integer jp;
    extern /* Subroutine */ int dlamrg_(), xerbla_();
