/* dlasdq.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasdq_(uplo, sqre, n, ncvt, nru, ncc, d__, e, vt, ldvt, 
	u, ldu, c__, ldc, work, info, uplo_len)
char *uplo;
integer *sqre, *n, *ncvt, *nru, *ncc;
doublereal *d__, *e, *vt;
integer *ldvt;
doublereal *u;
integer *ldu;
...
ftnlen uplo_len;
{
    ...
    extern /* Subroutine */ int dlartg_(), xerbla_(), dbdsqr_();
