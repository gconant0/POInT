/* dgesdd.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dgesdd_(jobz, m, n, a, lda, s, u, ldu, vt, ldvt, work, 
	lwork, iwork, info, jobz_len)
char *jobz;
integer *m, *n;
doublereal *a;
integer *lda;
