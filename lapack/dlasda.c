/* dlasda.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasda_(icompq, smlsiz, n, sqre, d__, e, u, ldu, vt, k, 
	difl, difr, z__, poles, givptr, givcol, ldgcol, perm, givnum, c__, s, 
	work, iwork, info)
integer *icompq, *smlsiz, *n, *sqre;
doublereal *d__, *e, *u;
integer *ldu;
doublereal *vt;
integer *k;
doublereal *difl, *difr, *z__, *poles;
integer *givptr, *givcol, *ldgcol, *perm;
doublereal *givnum, *c__, *s, *work;
integer *iwork, *info;
{
    ...
    extern /* Subroutine */ int dlasd6_();
    static integer ic, nwork1, lf, nd, nwork2, ll, nl, vf, nr, vl;
    extern /* Subroutine */ int dlasdq_(), dlasdt_(), dlaset_(), xerbla_();
