/* dlasd8.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd8_(icompq, k, d__, z__, vf, vl, difl, difr, lddifr, 
	dsigma, work, info)
integer *icompq, *k;
doublereal *d__, *z__, *vf, *vl, *difl, *difr;
integer *lddifr;
doublereal *dsigma, *work;
integer *info;
{
