/* dtrtri.f -- translated by f2c (version 19970805).
...
/* Subroutine */ int dtrtri_(uplo, diag, n, a, lda, info, uplo_len, diag_len)
char *uplo, *diag;
integer *n;
doublereal *a;
integer *lda, *info;
...
/*        Use unblocked code */
	...
	dtrti2_(uplo, diag, n, &a[a_offset], lda, info, 1L, 1L);
    } else {
...
/*              Compute rows 1:j-1 of current block column */
		...
		dtrmm_("Left", "Upper", "No transpose", diag, &i__4, &jb, &
			c_b18, &a[a_offset], lda, &a[j * a_dim1 + 1], lda, 4L,
			 5L, 12L, 1L);
		i__4 = j - 1;
...
/*              Compute inverse of current diagonal block */
		...
		dtrti2_("Upper", diag, &jb, &a[j + j * a_dim1], lda, info, 5L,
			 1L);
/* L20: */
	    }
	} else {
...
/*              Compute inverse of current diagonal block */
		...
		dtrti2_("Lower", diag, &jb, &a[j + j * a_dim1], lda, info, 5L,
			 1L);
/* L30: */
	    }
	}
