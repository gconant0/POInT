/* dbdsdc.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dbdsdc_(uplo, compq, n, d__, e, u, ldu, vt, ldvt, q, iq, 
	work, iwork, info, uplo_len, compq_len)
char *uplo, *compq;
integer *n;
doublereal *d__, *e, *u;
integer *ldu;
...
ftnlen compq_len;
{
    ...
    extern /* Subroutine */ int dlasr_(), dcopy_(), dswap_();
    static integer poles, iuplo, nsize, start;
    extern /* Subroutine */ int dlasd0_();
    static integer ic, ii, kk;
    static doublereal cs;
    extern doublereal dlamch_();
    extern /* Subroutine */ int dlasda_();
    static integer is, iu;
    static doublereal sn;
    extern /* Subroutine */ int dlascl_(), dlasdq_(), dlaset_(), dlartg_();
