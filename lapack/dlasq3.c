/* dlasq3.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasq3_(i0, n0, z__, pp, dmin__, sigma, desig, qmax, 
	nfail, iter, ndiv, ieee)
integer *i0, *n0;
doublereal *z__;
integer *pp;
doublereal *dmin__, *sigma, *desig, *qmax;
integer *nfail, *iter, *ndiv;
logical *ieee;
{
    /* Initialized data */
    ...
    static integer j4;
    extern /* Subroutine */ int dlasq4_(), dlasq5_(), dlasq6_();
