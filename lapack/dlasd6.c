/* dlasd6.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd6_(icompq, nl, nr, sqre, d__, vf, vl, alpha, beta, 
	idxq, perm, givptr, givcol, ldgcol, givnum, ldgnum, poles, difl, difr,
	 z__, k, c__, s, work, iwork, info)
integer *icompq, *nl, *nr, *sqre;
doublereal *d__, *vf, *vl, *alpha, *beta;
integer *idxq, *perm, *givptr, *givcol, *ldgcol;
doublereal *givnum;
integer *ldgnum;
doublereal *poles, *difl, *difr, *z__;
integer *k;
doublereal *c__, *s, *work;
integer *iwork, *info;
{
    ...
    extern /* Subroutine */ int dlasd7_(), dlasd8_();
    static integer iw;
    extern /* Subroutine */ int dlascl_(), dlamrg_();
