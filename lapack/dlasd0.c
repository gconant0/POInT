/* dlasd0.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd0_(n, sqre, d__, e, u, ldu, vt, ldvt, smlsiz, iwork,
	 work, info)
integer *n, *sqre;
doublereal *d__, *e, *u;
integer *ldu;
doublereal *vt;
integer *ldvt, *smlsiz, *iwork;
doublereal *work;
integer *info;
{
    ...
    extern /* Subroutine */ int dlasd1_();
    static integer ic, lf, nd, ll, nl, nr;
    extern /* Subroutine */ int dlasdq_(), dlasdt_(), xerbla_();
