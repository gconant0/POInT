/* dlasd2.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd2_(nl, nr, sqre, k, d__, z__, alpha, beta, u, ldu, 
	vt, ldvt, dsigma, u2, ldu2, vt2, ldvt2, idxp, idx, idxc, idxq, coltyp,
	 info)
integer *nl, *nr, *sqre, *k;
doublereal *d__, *z__, *alpha, *beta, *u;
integer *ldu;
doublereal *vt;
integer *ldvt;
doublereal *dsigma, *u2;
integer *ldu2;
doublereal *vt2;
integer *ldvt2, *idxp, *idx, *idxc, *idxq, *coltyp, *info;
{
    ...
    static integer jp;
    extern /* Subroutine */ int dlamrg_(), dlacpy_(), dlaset_(), xerbla_();
