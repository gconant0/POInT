/* dlasd4.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd4_(n, i__, d__, z__, delta, rho, sigma, work, info)
integer *n, *i__;
doublereal *d__, *z__, *delta, *rho, *sigma, *work;
integer *info;
{
    ...
    extern /* Subroutine */ int dlaed6_(), dlasd5_();
