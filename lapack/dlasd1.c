/* dlasd1.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd1_(nl, nr, sqre, d__, alpha, beta, u, ldu, vt, ldvt,
	 idxq, iwork, work, info)
integer *nl, *nr, *sqre;
doublereal *d__, *alpha, *beta, *u;
integer *ldu;
doublereal *vt;
integer *ldvt, *idxq, *iwork;
doublereal *work;
integer *info;
{
    ...
    extern /* Subroutine */ int dlasd2_(), dlasd3_();
    static integer iq;
    extern /* Subroutine */ int dlascl_();
    static integer iz;
    extern /* Subroutine */ int dlamrg_();
