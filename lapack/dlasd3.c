/* dlasd3.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlasd3_(nl, nr, sqre, k, d__, q, ldq, dsigma, u, ldu, u2,
	 ldu2, vt, ldvt, vt2, ldvt2, idxc, ctot, z__, info)
...
integer *info;
{
    ...
    extern /* Subroutine */ int dlasd4_();
    static integer jc;
    extern /* Subroutine */ int dlascl_(), dlacpy_(), xerbla_();
