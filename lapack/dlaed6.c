/* dlaed6.f -- translated by f2c (version 20000121).
...
/* Subroutine */ int dlaed6_(kniter, orgati, rho, d__, z__, finit, tau, info)
integer *kniter;
logical *orgati;
doublereal *rho, *d__, *z__, *finit, *tau;
integer *info;
{
    /* Initialized data */
